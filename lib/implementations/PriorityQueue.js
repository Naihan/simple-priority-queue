...
var PriorityQueue = /** @class */ (function () {
    function PriorityQueue(isMaxHeap) {
        if (isMaxHeap === void 0) { isMaxHeap = false; }
        this._binaryHeap = new BinaryHeap_1.default(isMaxHeap);
    }
    PriorityQueue.prototype.enqueue = function (nodeData, nodePriority) {
    ...
    PriorityQueue.prototype.heapSort = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._binaryHeap.heapSort()];
                    case 1:
                        sortedHeap = _a.sent();
                        return [2 /*return*/, sortedHeap];
                }
            });
        });
    };
